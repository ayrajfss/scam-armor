...
public class investment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbarTitle.setText("INVESTMENT SCAMS");
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(item -> {
            ...
            if (itemId == R.id.navigation_home) {
                intent = new Intent(investment.this, MainActivity.class);
                intent.putExtra("isAdmin", isAdmin); // Pass isAdmin to MainActivity
            } else if (itemId == R.id.navigation_scan_text) {
                intent = new Intent(investment.this, scantext.class);
                intent.putExtra("isAdmin", isAdmin); // Pass isAdmin to scantext
            } else if (itemId == R.id.navigation_community_forum) {
                intent = new Intent(investment.this, communityforum.class);

...
public class cashreward extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cashreward);
        ...
        toolbarTitle.setText("CASH REWARD SCAMS");
        ...
        toolbar.setNavigationOnClickListener(view -> {
            Intent intent = new Intent(cashreward.this, MainActivity.class);
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(item -> {
            ...
            if (itemId == R.id.navigation_home) {
                intent = new Intent(cashreward.this, MainActivity.class);
                intent.putExtra("isAdmin", isAdmin); // Pass isAdmin to MainActivity
            } else if (itemId == R.id.navigation_scan_text) {
                intent = new Intent(cashreward.this, scantext.class);
                intent.putExtra("isAdmin", isAdmin); // Pass isAdmin to scantext
            } else if (itemId == R.id.navigation_community_forum) {
                intent = new Intent(cashreward.this, communityforum.class);
